...
public class DrawAtomLabel {
   ...
   DrawAtomLabel(GUIData guiData, int ID){
      this.guiData = guiData;
      this.ID = ID;
      guiData.setDrawAtomLabel(ID, this);
   ...
   public void createSceneGraph(){
      ...
      for(int n=0; n<molecule.getNat(); n++){
         ...
         Text2D text = new Text2D(atom.getLabel(), new Color3f(Color.BLACK), "Dialog", 12, java.awt.Font.BOLD);
