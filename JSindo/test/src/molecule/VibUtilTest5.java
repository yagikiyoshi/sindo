...
public class VibUtilTest5 {

   public static void main(String[] args){
      
      MInfoIO minfo = new MInfoIO();
      try{
         minfo.loadMOL("test/molecule/water_trimer4.minfo");
      }catch(IOException e){
         e.printStackTrace();
         System.exit(-1);
      }
      ...
      /*
      VibrationalData vd0 = w3.getVibrationalData(0);
      VibrationalData vd1 = w3.getVibrationalData(1);
      VibrationalData vd2 = w3.getVibrationalData(2);
      
      int nd = w3.getNumOfVibrationalData();
      System.out.println("# of domain = "+nd);
      
      VibrationalData vd = vutil.combineVibData(vd0, vd1);
      vd = vutil.combineVibData(vd, vd2);
      
      w3.clearVibrationalData();
      w3.addVibrationalData(vd);
      */
      
      try {
         minfo.dumpMOL("test/molecule/water_trimer5.minfo");
      } catch (IOException e) {
         e.printStackTrace();
      }
